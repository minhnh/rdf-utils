...
URI_OBS_PRED_MAX_TIME_OFFSET = NS_MM_OBS["max-time-offset"]
...
URI_QUDT_UNIT_HZ = NS_MM_QUDT_UNIT["HZ"]
URI_QUDT_UNIT_SEC = NS_MM_QUDT_UNIT["SEC"]
URI_QUDT_UNIT_RAD = NS_MM_QUDT_UNIT["RAD"]
URI_QUDT_UNIT_DEG = NS_MM_QUDT_UNIT["DEG"]
URI_QUDT_UNIT_RAD_PER_SEC = NS_MM_QUDT_UNIT["RAD-PER-SEC"]
URI_QUDT_UNIT_DEG_PER_SEC = NS_MM_QUDT_UNIT["DEG-PER-SEC"]
URI_QUDT_UNIT_RAD_PER_SEC2 = NS_MM_QUDT_UNIT["RAD-PER-SEC2"]
URI_QUDT_UNIT_DEG_PER_SEC2 = NS_MM_QUDT_UNIT["DEG-PER-SEC2"]
URI_QUDT_UNIT_N_M = NS_MM_QUDT_UNIT["N-M"]
...
URI_ROS_TYPE_TRANSFORM_LISTENER = NS_MM_ROS["TransformListener"]
URI_ROS_PRED_CHNL_NAME = NS_MM_ROS["channel-name"]
URI_ROS_PRED_TYPE_NAME = NS_MM_ROS["type-name"]
URI_ROS_PRED_REFERENCE_FRAME = NS_MM_ROS["reference-frame"]
...
URI_GEOM_TYPE_VELOCITY_TWIST = NS_MM_GEOM_REL["VelocityTwist"]
URI_GEOM_TYPE_ACCEL_TWIST = NS_MM_GEOM_REL["AccelerationTwist"]
...
URI_GEOM_PRED_HAS_COORD_POLICY = NS_MM_GEOM_COORD["has-coordinate-policy"]
...
URI_GEOM_PRED_W = NS_MM_GEOM_COORD["w"]
...
URI_KC_STAT_JNT_ACC = NS_MM_KC_STAT["JointAcceleration"]
...
URI_KC_EXT_PRED_ANCHOR = NS_MM_KC_EXT["anchor"]
...
URI_EXEC_PRED_RUNS_SCENE = NS_MM_EXEC["runs-scene"]
